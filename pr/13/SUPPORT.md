# Getting help with bookclubcron

Thanks for using bookclubcron! Before filing an issue, there are a few
...
- If it’s a question: It’s best to ask on the [Data Science Learning
  Community Slack](https://DSLC.io/join). Other options include [Posit
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/r4ds/bookclubcron/issues/new).
...
requests](https://github.com/r4ds/bookclubcron/issues) to make sure the
